...
function ticketNotice(record) {
  ...
  const controls=[
    button('ticket:claim',record.claimedBy?'Claimed':'Claim',D.ButtonStyle.Success).setDisabled(Boolean(record.claimedBy)),
    button('ticket:close','Close',D.ButtonStyle.Danger),button('ticket:escalate','Escalate',D.ButtonStyle.Secondary)];
