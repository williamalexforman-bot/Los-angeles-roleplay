...
import { paidAdCommand } from './paidAds';
import { roleAdCreatorCommand } from './roleAdCreator';
...
addCommands('paidAds', paidAdCommand);
addCommands('roleAdCreator', roleAdCreatorCommand);
