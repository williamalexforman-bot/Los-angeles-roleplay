...
function recoverInfractionFromSummary(
    ...
    return {
        ...
        ruleBroken: summaryLine(summary, 'Notes', 'No rule supplied.'),
        evidence: summaryLine(summary, 'Evidence', 'No evidence supplied.'),
        internalNotes: summaryLine(summary, 'Internal Notes', 'No internal notes supplied.'),
        notifyMember: false,
...
function infractionSummary(record: InfractionRecord): string {
    ...
    return [
        ...
        `> **Notes:** \`${compactCaseValue(record.ruleBroken)}\``,
