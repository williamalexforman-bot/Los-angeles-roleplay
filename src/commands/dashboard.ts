...
const DASHBOARD_TEXT = [
    ...
    '> <#1526034504953892925>  `If you need any help`','> <#1526035127606706196>  `Buy LA VIP and more`','> <#1526035041593856182>  `Apply here`','> <#1526046592187105421>  `Read server regulations`','> <#1541110029048881313>  `Verify here`',
].join('\n');
